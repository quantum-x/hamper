...
def rotate_90_counterclockwise(x, y):
    ...
    scaled_x = x * (1 + scale_x) + shift_x
    scaled_y = y * (1 + scale_y) + shift_y
...
scale_x = 1.2  # 180%
scale_y = 1.18  # 118%
shift_x = 1500  # Shift X-axis by 5 units to the right
shift_y = 1500  # Shift Y-axis by 5 units to the right
